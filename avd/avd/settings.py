...
SECRET_KEY = 'django-insecure-jg4j9)2qzt&zk!kc30lj=81)(*m3%bq4hojl4x0o#)%87%q%23'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'base/static/base')
MEDIA_URL = '/media/'
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.path.join(BASE_DIR, 'avd_cache'),
    }
}
